...
$(document).ready(function(){
    ...
    $('.btn_buscar').click(function(){
    	var valor_buscar = $('.text_busc').val();
    	$(location).attr('href','http://localhost/admin/admin/home/search/'+valor_buscar);
...
<div id="page-top">
	...
	<!-- start logo -->
	<div id="logo">
	<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>/images/logo_2.png"  alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<div id="top-search">
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><input type="text" name="search" value="Search" onblur="if (this.value=='') { this.value='Search'; }" onfocus="if (this.value=='Search') { this.value=''; }" class="top-search-inp text_busc" /></td>
			<td>
				<input type="image" class="btn_buscar" src="<?php echo base_url(); ?>images/shared/top_search_btn.gif"  />
			</td>
			</tr>
		</table>
	</div>
...
<div class="nav-outer"> 
		...
		<ul class="select">
			<li><a href="<?php echo base_url(); ?>"><b>Empleados</b><!--[if IE 7]><!--></a>
				<div class="select_sub">
					<ul class="sub">
						<li><a href="<?php echo base_url(); ?>register">Registar Empleado</a></li>
					</ul>
				</div>
			</li>
		</ul>
